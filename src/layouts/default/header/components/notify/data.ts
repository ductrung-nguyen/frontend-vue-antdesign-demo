  ...
  },
  {
    ...
    list: [
      ...
      },
      {
        ...
        title: 'Title',
        description:
          'Move your mouse here to test how very long messages are handled here. In this example, the maximum number of lines in the description is set to 2. The description content of more than 2 lines will be omitted and the complete content can be viewed through the tooltip',
        datetime: '2017-08-07',
        type: '2',
        clickClose: true,
      },
