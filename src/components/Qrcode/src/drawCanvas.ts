...
export const renderQrCode = ({
  ...
  // Error tolerance rate. By default, high error tolerance rate is used for QR codes with less content,
  // and low error tolerance rate is used for QR codes with more content.
