<template>
  <PageWrapper
    ...
    contentBackground
    contentClass="p-4"
    content="Since the user information interface will be requested when refreshing, the role information will be reset according to the API, so the interface will be restored to its original state after the refresh. If not, you can comment the user information interface in src/layout/default/index"
  >
