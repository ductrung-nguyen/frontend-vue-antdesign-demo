...
export interface CompensationHeight {
  // Do we use layout Footer? (a condition for calculating compensation height)
...
/**
 * Dynamically calculate the height of the content, according to the lowest coordinate of the anchor dom
 * to the lowest coordinate of the screen, and dynamically calculate according to the height, padding, margin
 * and other values of the incoming dom
 *
 * @param flag Reactive flag to start computation
 ...
 * @param substractSpaceRefs List of components whose the space should be subtracted(margins/paddings)   Ref<ElRef | ComponentRef>
 * @param offsetHeightRef Calculate the offset responsive height, this value will be directly subtracted when calculating the height
 * @param upwardSpace Recursively upwards minus the level of free space or until the specified class.
 *         A value of 2 means recursing upwards twice | A value of ant-layout means recursing upwards until it encounters .ant-layout
